...
from db.clinics import upsert as clinics_upsert, get_by_id as clinics_get_by_id
from importers.clinics_excel import parse_clinics_excel
...
with tab2:
    ...
    if clinic is None and clinic_id:
        clinic = clinics_get_by_id(int(clinic_id)) or {"clinic_id": int(clinic_id), "legal_name": "", "status": "Prospect"}
